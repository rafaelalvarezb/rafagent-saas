# 🚀 PROMPT COMPLETO PARA NUEVO CHAT - RAFAGENT (NOVIEMBRE 19, 2025 - 5:30 PM)
...
- `PROMPT_NUEVO_CHAT_NOV_19_5:30PM_2025.md` - **ESTE ARCHIVO** - Contexto completo actualizado
- `docs/old_prompts/PROMPT_NUEVO_CHAT_DICIEMBRE_2025.md` - Contexto anterior (útil para historia)
...
### Contexto General:
1. **`PROMPT_NUEVO_CHAT_NOV_19_5:30PM_2025.md`** - **ESTE ARCHIVO** - Contexto completo más actualizado
2. **`docs/old_prompts/PROMPT_NUEVO_CHAT_DICIEMBRE_2025.md`** - Contexto anterior (útil para historia)
...
- **Siempre lee los archivos markdown** antes de hacer cambios, especialmente `PROMPT_NUEVO_CHAT_NOV_19_5:30PM_2025.md`
...
- **Si necesitas entender una funcionalidad**, lee el código relacionado primero:
  ...
  - UI: `src/pages/Prospects.tsx`, `src/pages/Dashboard.tsx`, `src/pages/Configuration.tsx`
...
## 📋 RESUMEN DE CAMBIOS RECIENTES (DICIEMBRE 2025 - ENERO 2026)

### Diciembre 2025 - Mejoras Implementadas:

1. **Fix: Timezone no se mostraba correctamente después de guardar** ✅
   - Agregado `useEffect` en `TimezoneSelector` para sincronizar estado interno
   - Mejorado `onSuccess` en `Configuration` para actualizar estado local inmediatamente
   - El timezone ahora se muestra correctamente después de guardar cambios

2. **Toggle de Vista Admin/Estándar** ✅
   ...
   - Ocultar secciones de admin (Engine Status y Registered Users) cuando toggle está OFF
   - Permite hacer demos con vista de usuario estándar sin mostrar secciones admin

3. **Detención Inteligente de Secuencias** ✅
